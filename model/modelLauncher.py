...
class ModelLauncher:
    ...
    def __init__(self, api: str):
        ...
        self.script_path = os.path.join(config.DIR_TRIGGER_RESOURCE, config.MODEL_REGISTRY[api])
    ...
    def preheat(api: str):
        ...
        script_path = os.path.join(config.DIR_TRIGGER_RESOURCE, config.MODEL_REGISTRY[api])
